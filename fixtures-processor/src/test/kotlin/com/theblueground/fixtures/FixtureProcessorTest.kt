...
class FixtureProcessorTest : KSPTest() {
    ...
    @Test
    fun `should generate a builder function with Duration parameter`() {
        // Given
        val fixtureSource = """
                    package $packageName
                    ...
                    @Fixture
                    data class $fixtureName(val duration: Duration)
        """.trimIndent()
        val fixtureFile = kotlin(name = "$fixtureName.kt", contents = fixtureSource)
        ...
        val expected = """
            ...
            public fun create$fixtureName(duration: Duration = Duration.ZERO): $fixtureName = $packageName.$fixtureName(
            	duration = duration
            )
    ...
    @Test
    fun `should generate a builder function with value class parameter`() {
        // Given
        val fixtureSource = """
                    package $packageName
                    ...
                    @Fixture
                    data class $fixtureName(val id: SubscriptionId)
        ...
        val expected = """
            ...
            public fun create$fixtureName(id: SubscriptionId = SubscriptionId("value")): $fixtureName =
                $packageName.$fixtureName(
            	id = id
            )
